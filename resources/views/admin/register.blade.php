                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.register') }}">
                        ...
                        <div class="form-group{{ $errors->has('image_link') ? ' has-error' : '' }}">
                            <label for="image_link" class="col-md-4 control-label">Image_link</label>

                            <div class="col-md-6">
                                <input id="image_link" type="text" class="form-control" name="image_link" value="{{ old('image_link') }}" required autofocus>
